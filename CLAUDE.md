...
| DOM screenshots | html-to-image (bundled under `public/js/vendor/`) — pixel-accurate SVG-foreignObject capture of the asset-details active tab; CSP `connect-src` whitelists the Google Fonts hosts so webfonts embed into the PNG |
